...
class GestorHoteles:
    ...
    def buscaPorNombre(self, xnom):     # hacer bloque try
        i = 0
        encontrado = False
    ...
    def Inciso1(self, xnomb):
        indice = self.buscaPorNombre(xnomb)     # hacer bloque try
    ...
    def inciso2(self, xnom, xnum):
        ...
        subindice = self.__listaHoteles[indice].buscaPorNum(xnum)   # hacer bloque try
